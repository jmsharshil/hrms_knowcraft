...
class JobApplication(models.Model):
    ...
    ("interview_next_3", "Shortlisted For Round 3"),
    ("interview_pending_3", "Interview 3 Pending"),
    ("interview_done_3", "Interview 3 Completed"),
    ("interview_rejected_3", "Rejected After Interview 3"),
