...
class ReferralApplicationSerializer(serializers.ModelSerializer):
    ...
    def get_status_display(self, obj):
        ...
        try:
            ...
            STATUS_RANK = {
                'received': 10, 'duplicate_rejected': 0, 'shortlisted': 20,
                'interview_pending_1': 25, 'interview_done_1': 30, 'interview_rejected_1': 15,
                'interview_next_2': 35, 'interview_pending_2': 40, 'interview_done_2': 45,
                'interview_rejected_2': 20, 'interview_next_3': 50, 'interview_pending_3': 55,
                'interview_done_3': 60, 'interview_rejected_3': 25, 'interview_next_final': 65,
                'interview_pending_final': 70, 'interview_done_final': 75, 'interview_rejected_final': 30,
                'interview_next_management_client': 80, 'interview_pending_management_client': 85,
                'interview_done_management_client': 90, 'interview_rejected_management_client': 35,
                'consolidated_result_review': 92, 'selected': 95, 'approval_pending': 96,
                'approved': 97, 'approval_rejected': 40, 'salary_annexure_prep': 98,
                'salary_annexure_review': 99, 'approved_annexure': 100, 'rejected_annexure': 45,
                'offer_pending': 101, 'offer_sent': 102, 'offer_accepted': 103, 'offer_rejected': 50,
                'docs_pending': 104, 'docs_uploaded': 105, 'review_docs': 106, 'docs_approved': 107,
                'docs_incomplete': 55, 'docs_unclear': 56, 'joining_pending': 110,
                'joining_poned': 108, 'joined': 120, 'rejected': 5,
            }
