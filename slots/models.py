...
class InterviewFeedback(models.Model):
    ...
    communication_rating = models.IntegerField(default=0)
    technical_skill_rating = models.IntegerField(default=0)
    attitude_intent_rating = models.IntegerField(default=0)
    team_handling_rating = models.IntegerField(default=0)
    stability_rating = models.IntegerField(default=0)
    problem_solving_rating = models.IntegerField(default=0)
    analytical_thinking_rating = models.IntegerField(default=0)
    cultural_fit_rating = models.IntegerField(default=0)
    is_selected = models.BooleanField(default=True)
