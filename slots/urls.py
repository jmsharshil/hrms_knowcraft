...
from slots.views import InterviewerView,InterviewFeedbackListCreateAPIView,InterviewFeedbackDetailAPIView,InterviewLocationListCreateAPIView,InterviewLocationDetailAPIView
urlpatterns = [
