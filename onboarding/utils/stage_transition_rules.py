ALLOWED_TRANSITIONS = {
    ...
    "interview_done_1": ["interview_next_2","interview_next_3","interview_next_final", "interview_rejected_1","selected","interview_next_management_client"],
    "interview_next_2":["interview_pending_2","interview_rejected_1"],
    "interview_pending_2": ["interview_done_2"],
    "interview_done_2": ["interview_next_final","interview_next_3", "interview_rejected_2","selected","interview_next_management_client"],
    "interview_next_3":["interview_pending_3","interview_rejected_2"],
    "interview_pending_3": ["interview_done_3"],
    "interview_done_3": ["interview_next_final", "interview_rejected_3","selected","interview_next_management_client"],
    "interview_next_final":["interview_pending_final","interview_rejected_3"],
    "interview_pending_final": ["interview_done_final"],
    "interview_done_final": ["selected", "interview_rejected_final","interview_next_management_client"],
    ...
    "interview_done_management_client":["selected","interview_rejected_management_client"],
    # APPROVAL
