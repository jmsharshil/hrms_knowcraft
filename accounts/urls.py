...
from .views import (
    ...
    UserListView, UserDetailView, UserSoftDeleteView, CurrentUserView, ResendMagicLinkView, ForgotPasswordView
)
...
urlpatterns = [
    ...
    path('users/<uuid:pk>/soft_delete/', UserSoftDeleteView.as_view(), name='user-soft-delete'),
